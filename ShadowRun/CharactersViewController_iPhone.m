//
//  CharactersViewController_iPhone.m
//  ShadowRun
//
...
@implementation CharactersViewController_iPhone
...
- (void)viewDidLoad
{
    ...
    NSError *error;
    self.characters = [self.context executeFetchRequest:fetchRequest error:&error];
